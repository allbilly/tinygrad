...
**Current summary: 144 PASS, 272 FAIL, 8 SKIP (424 unique tests).**

This is the previous complete hardware census plus independently rerun LUT
milestones. SQRT, RSQRT, EXP, special-value division, HardSwish, CELU, ordinary
QuickGELU, and extreme tanh moved to PASS.
...
|---|---:|---|
| PASS | 144 | Core fp16 arithmetic/casts/fills/rounding, comparisons/predicates/sign, WHERE/clip/abs/minimum/maximum, affine copies, GEMM subsets, selected reductions/activations/LUT special values, and uint8 ReLU cast |
...
| FAIL: numeric mismatch | 19 | Remaining LUT/activation precision, fp16 accumulation/rounding, and special values |
...
`test_diagonal`, `test_div`, `test_div_naninf`, `test_double_slice`, `test_einsum_arity_check1`,
...
`test_hardsigmoid`, `test_hardsigmoid_extreme`, `test_hardswish`, `test_hardtanh`, `test_idiv_shift_rewrite_negative`,
...
`test_prod_dtype_arg`, `test_quick_gelu`, `test_quick_gelu_extreme`, `test_relu`, `test_relu6`, `test_relu_exact`,
...
`test_tanh_extreme`, `test_topo_sort`, `test_transpose`, `test_trunc`, `test_unflatten`, `test_unfold`,
...
two-LUT QuickGELU, and extreme tanh assertions. A single-process run retains
