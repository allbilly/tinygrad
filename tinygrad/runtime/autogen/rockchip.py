...
REG_PPU_S_POINTER = 0x00006004
REG_PPU_DATA_CUBE_IN_WIDTH = 0x0000600c
REG_PPU_DATA_CUBE_IN_HEIGHT = 0x00006010
REG_PPU_DATA_CUBE_IN_CHANNEL = 0x00006014
REG_PPU_DATA_CUBE_OUT_WIDTH = 0x00006018
REG_PPU_DATA_CUBE_OUT_HEIGHT = 0x0000601c
REG_PPU_DATA_CUBE_OUT_CHANNEL = 0x00006020
REG_PPU_OPERATION_MODE_CFG = 0x00006024
REG_PPU_POOLING_KERNEL_CFG = 0x00006034
REG_PPU_DST_BASE_ADDR = 0x00006070
REG_PPU_DST_SURF_STRIDE = 0x0000607c
REG_PPU_DATA_FORMAT = 0x00006084
REG_PPU_MISC_CTRL = 0x000060dc
REG_PPU_RDMA_S_POINTER = 0x00007004
REG_PPU_RDMA_CUBE_IN_WIDTH = 0x0000700c
REG_PPU_RDMA_CUBE_IN_HEIGHT = 0x00007010
REG_PPU_RDMA_CUBE_IN_CHANNEL = 0x00007014
REG_PPU_RDMA_SRC_BASE_ADDR = 0x0000701c
REG_PPU_RDMA_SRC_LINE_STRIDE = 0x00007024
REG_PPU_RDMA_SRC_SURF_STRIDE = 0x00007028
REG_PPU_RDMA_DATA_FORMAT = 0x00007030
REG_PPU_RDMA_OPERATION_ENABLE = 0x00007038
