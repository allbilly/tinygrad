...
# Native NVDLA SDP_D_DP_EW_CFG fields. ADD uses the ALU SUM path and MUL uses
# the multiplier path; the unused path and LUT are bypassed in each case.
_SDP_EW_CFGS = {Ops.ADD: 0x58, Ops.MUL: 0x42}
...
def _emit_sdp(task: NVDLATask) -> NVDLAImage:
  ...
  This first native path represents the flat tinygrad buffer as one 1x1
  NCxHWx cube. It intentionally supports only ADD and MUL."""
  if task.ew_op not in _SDP_EW_CFGS: raise RuntimeError(f"nvdla: unsupported SDP op: {task.ew_op}")
  cmds, relocs, e, r = _make_emitter()
  total = task.layout[0]
  atom_stride = 32  # nv_small FP16 feature atom: 16 channels * 2 bytes
  # Select producer group 0 and clear its stale completion interrupt.
  e(nv.NVDLA_SDP_S_POINTER_0, 0)
  e(nv.NVDLA_SDP_RDMA_S_POINTER_0, 0)
  e(nv.NVDLA_GLB_S_INTR_STATUS_0, 1)
  # SDP core: memory input/output, 1x1xC cube, FP16 processing and output.
  e(nv.NVDLA_SDP_D_FEATURE_MODE_CFG_0, 0)
  e(nv.NVDLA_SDP_D_DATA_FORMAT_0, 0xa)
  e(nv.NVDLA_SDP_D_DATA_CUBE_CHANNEL_0, total - 1)
  e(nv.NVDLA_SDP_D_DATA_CUBE_WIDTH_0, 0)
  e(nv.NVDLA_SDP_D_DATA_CUBE_HEIGHT_0, 0)
  e(nv.NVDLA_SDP_D_DST_LINE_STRIDE_0, atom_stride)
  e(nv.NVDLA_SDP_D_DST_SURFACE_STRIDE_0, atom_stride)
  e(nv.NVDLA_SDP_D_DST_DMA_CFG_0, 1)                    # MC
  # SDP RDMA: memory source, same 1x1xC cube, FP16 throughout.
  e(nv.NVDLA_SDP_RDMA_D_DATA_CUBE_WIDTH_0, 0)
  e(nv.NVDLA_SDP_RDMA_D_DATA_CUBE_HEIGHT_0, 0)
  e(nv.NVDLA_SDP_RDMA_D_DATA_CUBE_CHANNEL_0, total - 1)
  e(nv.NVDLA_SDP_RDMA_D_SRC_LINE_STRIDE_0, atom_stride)
  e(nv.NVDLA_SDP_RDMA_D_SRC_SURFACE_STRIDE_0, atom_stride)
  e(nv.NVDLA_SDP_RDMA_D_SRC_DMA_CFG_0, 1)               # MC
  e(nv.NVDLA_SDP_RDMA_D_BRDMA_CFG_0, 1)                 # disabled
  e(nv.NVDLA_SDP_RDMA_D_NRDMA_CFG_0, 1)                 # disabled
  e(nv.NVDLA_SDP_RDMA_D_ERDMA_CFG_0, 0x3a if task.ew_op is Ops.ADD else 0x38)
  e(nv.NVDLA_SDP_RDMA_D_EW_LINE_STRIDE_0, atom_stride)
  e(nv.NVDLA_SDP_RDMA_D_EW_SURFACE_STRIDE_0, atom_stride)
  # Output address (reloc patches at submit time)
  e(nv.NVDLA_SDP_D_DST_BASE_ADDR_LOW_0, 0)
  r(task.out_slot)
  e(nv.NVDLA_SDP_D_DST_BASE_ADDR_HIGH_0, 0)
  ...
  # Bypass BS/BN. Configure EW's active ALU or MUL input from memory.
  e(nv.NVDLA_SDP_D_DP_BS_CFG_0, 1)
  e(nv.NVDLA_SDP_D_DP_BN_CFG_0, 1)
  e(nv.NVDLA_SDP_D_DP_EW_CFG_0, _SDP_EW_CFGS[task.ew_op])
  if task.ew_op is Ops.ADD: e(nv.NVDLA_SDP_D_DP_EW_ALU_CFG_0, 3)
  else: e(nv.NVDLA_SDP_D_DP_EW_MUL_CFG_0, 3)
  e(nv.NVDLA_SDP_D_DP_EW_TRUNCATE_VALUE_0, 0)
  e(nv.NVDLA_SDP_D_CVT_OFFSET_0, 0)
  e(nv.NVDLA_SDP_D_CVT_SCALE_0, 1)
  e(nv.NVDLA_SDP_D_CVT_SHIFT_0, 0)
  e(nv.NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0, 0xa8)
