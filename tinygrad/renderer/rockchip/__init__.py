...
from tinygrad.renderer.rockchip.ir import (RKTarget as RKTarget, RKEngine as RKEngine, RKBufferKind, RKLayoutKind,
...
from tinygrad.renderer.rockchip.analysis import (strip_casts as _strip_casts, static_scalar as _static_scalar,
  conditional_index as _conditional_index, conditional_index_affine as _conditional_index_affine, conv_zero_padding as _conv_zero_padding,
  static_index_selected as _static_index_selected,
...
from tinygrad.renderer.rockchip.selector import (_cmac_tiled_output_bytes, _dense_half_ref, _cmac_weight_ref,
  _cmac_mask_payload, _cmac_selection_payload, _sparse_cmac_pipeline, _windowed_cmac_pipeline,
  _two_level_selector_program, _selector_program, _finish_program,
...
def lower_tiled_contract_result(sink:UOp) -> RKLowerResult:
  ...
  if not 1 <= k <= 128 or lhs_count > 8192 or rhs_count > 8192 or output_count*k > RK_MAX_TILED_CONTRACT_VISITS:
    return _unsupported(RKRejectKind.PLAN_STAGE_LIMIT,
