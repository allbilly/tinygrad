...
class TestOps(unittest.TestCase):
  ...
  def test_add(self):
    # helper_test_op([(1,1), (1,1)], lambda x,y: x.half()+y.half(), Tensor.add)
    # helper_test_op([(1,2), (1,2)], lambda x,y: x.half()+y.half(), Tensor.add)
    # helper_test_op([(2,2), (2,2)], lambda x,y: x+y, Tensor.add)
