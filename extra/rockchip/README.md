...
- generated EXP2, EXP, sigmoid, and refined SQRT/RSQRT LUT assets with
  declared domains;
...
contains 25,744, so `MAX_LINE_COUNT=25000 python sz.py` fails by 744 lines. The
handwritten backend is 771 counted lines (698 renderer/compiler and 73
