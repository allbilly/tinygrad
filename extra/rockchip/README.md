...
contains 26,202, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,202 lines. The
handwritten backend is 1,229 counted lines (1,156 renderer/compiler and 73
