...
contains 26,446, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,446 lines. The
handwritten backend is 1,473 counted lines (1,400 renderer/compiler and 73
