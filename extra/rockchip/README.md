...
contains 26,255, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,255 lines. The
handwritten backend is 1,282 counted lines (1,209 renderer/compiler and 73
