...
contains 26,315, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,315 lines. The
handwritten backend is 1,342 counted lines (1,269 renderer/compiler and 73
