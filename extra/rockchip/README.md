...
contains 26,172, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,172 lines. The
handwritten backend is 1,199 counted lines (1,126 renderer/compiler and 73
