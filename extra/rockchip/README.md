...
contains 26,283, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,283 lines. The
handwritten backend is 1,310 counted lines (1,237 renderer/compiler and 73
