...
contains 26,382, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,382 lines. The
handwritten backend is 1,409 counted lines (1,336 renderer/compiler and 73
