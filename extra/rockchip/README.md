...
contains 26,345, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,345 lines. The
handwritten backend is 1,372 counted lines (1,299 renderer/compiler and 73
