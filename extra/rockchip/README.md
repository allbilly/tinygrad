...
contains 26,417, so `MAX_LINE_COUNT=25000 python sz.py` fails by 1,417 lines. The
handwritten backend is 1,444 counted lines (1,371 renderer/compiler and 73
