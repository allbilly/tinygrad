...
LUTS = (
  ...
  LUT("ACOSH_CORE", lambda z: 2*math.acosh(1+abs(z)/48) if z < 0 else .5*math.acosh(1+z/2),
      2.0, 8192.0, 32768.0, 15, True),
  LUT("ACOSH_RANGE", lambda z: .25*math.acosh(2+abs(z)) if z < 0 else .125*math.acosh(max(1.0,19*z)),
      16.0, 1024.0, 32768.0, 15, True, ((0,512,round(.25*math.acosh(2)*32768)-1),)),
)
...
parts = ["# generated by extra/rockchip/gen_lut.py; do not edit", "from enum import IntEnum",
         ...
         "  ATAN = 56\n  ATAN_DETAIL = 57\n  SIN = 58\n  SIN_LOCAL = 59\n  COS = 60\n  COS_LOCAL = 61\n"
         "  ATANH = 62\n  ATANH_DETAIL = 63\n  ASINH_CORE = 64\n  ASINH_RANGE = 65\n"
         "  ACOSH_CORE = 66\n  ACOSH_RANGE = 67", "RK_LUT_SCHEMA = 26"]
for spec in LUTS:
